...
// Heading
$_['heading_title'] = '<img width="24" height="24" src="view/image/neoseo.png" style="margin-right: 10px;float: left;"><p style="margin:0;line-height: 24px;">NeoSeo Pop-up comparison</p>';
$_['heading_title_raw'] = 'NeoSeo Pop-up comparison';
...
$_['entry_show_last_product'] = 'Show only last product';
