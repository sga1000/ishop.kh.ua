...
// Heading
$_['heading_title'] = '<img width="24" height="24" src="view/image/neoseo.png" style="margin-right: 10px;float: left;"><p style="margin:0;line-height: 24px;">NeoSeo Featured';
$_['heading_title_raw'] = 'NeoSeo Featured';
$_['new_title'] = 'NeoSeo Featured';
...
$_['entry_use_banner'] = "Use banner";
$_['entry_banner'] = "Image for banner";
$_['entry_banner_link'] = "Link for banner";
$_['entry_block_description'] = "Block description";
$_['entry_banner_width'] = "Banner Width";
$_['entry_banner_height'] = "Banner Height";
