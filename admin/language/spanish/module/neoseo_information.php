...
// Heading
$_['heading_title'] = '<img width="24" height="24" src="view/image/neoseo.png" style="margin-right: 10px;float: left;"><p style="margin:0;line-height: 24px;">NeoSeo Information</p>';
$_['heading_title_raw'] = 'NeoSeo Information';
...
$_['entry_height'] = 'Block height';
$_['entry_information_id'] = 'Information page';
$_['entry_title'] = 'Block title';
$_['entry_label'] = 'Name: ';


$_['entry_supplier_info'] = 'Supplier:';
...
$_['error_supplier_info'] = 'Required field!';
