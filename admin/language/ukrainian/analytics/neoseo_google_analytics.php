...
// Heading
$_['heading_title'] = '<img width="24" height="24" src="view/image/neoseo.png" style="float: left;"><span style="margin:0;line-height: 24px;">NeoSeo Google Analytics</span>';
$_['heading_title_raw'] = 'NeoSeo Google Analytics';
//Tab
$_['tab_general'] = 'Загальні';
$_['tab_support'] = 'Підтримка';
$_['tab_logs'] = 'Логі';
$_['tab_license'] = 'Ліцензия';
$_['tab_support'] = 'Підтримка';

//Button
$_['button_save'] = 'Зберігти';
...
$_['text_success_clear'] = 'Логі успішно видалені';
...
$_['entry_code_desc'] = 'Наприклад UA-37668896-1';
$_['entry_remarketing'] = 'Використовувати тег ремаркетингу:';
$_['entry_ecommerce'] = 'Відсилати ecommerce дані:';
// Error
