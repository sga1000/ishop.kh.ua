...
// Heading
$_['heading_title'] = '<img width="24" height="24" src="view/image/neoseo.png" style="margin-right: 10px;float: left;"><p style="margin:0;line-height: 24px;">NeoSeo Новинки товарів';
$_['heading_title_raw'] = 'NeoSeo Новинки товарів';
$_['new_title'] = 'Новинки товарів';
...
$_['text_default_title'] = 'Новинки товарів';
...
$_['entry_use_image'] = 'Використовувати картинку в блоці';
$_['entry_image'] = 'Зображення';
$_['entry_image_width'] = 'Ширина зображення';
$_['entry_image_height'] = 'Висота изображення';
