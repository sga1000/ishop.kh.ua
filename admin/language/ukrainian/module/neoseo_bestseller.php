...
// Heading
$_['heading_title'] = '<img width="24" height="24" src="view/image/neoseo.png" style="margin-right: 10px;float: left;"><p style="margin:0;line-height: 24px;">NeoSeo Хіти продаж';
$_['heading_title_raw'] = 'NeoSeo Хіти продаж';
$_['new_title'] = 'Хіти продаж';
...
$_['entry_use_image'] = 'Использовать картинку в блоке';
$_['entry_image'] = 'Зображення';
$_['entry_image_width'] = 'Ширина зображення';
$_['entry_image_height'] = 'Высота зображення';
