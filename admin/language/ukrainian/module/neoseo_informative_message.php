...
// Heading
$_['heading_title'] = '<img width="24" height="24" src="view/image/neoseo.png" style="float: left;"><span style="margin:0;line-height: 24px;">NeoSeo Інформативне повідомлення</span>';
$_['heading_title_raw'] = 'NeoSeo Інформативне повідомлення';
...
$_['entry_text'] = 'Повідомлення';
$_['entry_message_desc'] = "Введіть повідомлення, яке буде виведено в шапці сайту";
$_['entry_show_close_button'] = 'Виводити кнопку закриття вікна';
