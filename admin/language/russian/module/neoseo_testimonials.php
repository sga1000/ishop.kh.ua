...
// Heading
$_['heading_title'] = '<img width="24" height="24" src="view/image/neoseo.png" style="margin-right: 10px;float: left;"><p style="margin:0;line-height: 24px;">NeoSeo Отзывы о магазине';
$_['heading_title_raw'] = 'NeoSeo Отзывы о магазине';
$_['new_title'] = 'Отзывы о магазине';
...
$_['entry_youtube'] = 'Видео отзывы YouTube';
$_['entry_title'] = 'Заголовок';
$_['entry_limit'] = 'Количество';
$_['entry_description_limit'] = 'Сколько символов показывать (пусто - показать все)';
$_['entry_sort_order'] = 'Порядок:';
$_['entry_template'] = 'Шаблон:';


$_['entry_user_image_status'] = 'Пользовательское изображение';
$_['entry_user_image_width'] = 'Ширина изображения:';
$_['entry_user_image_height'] = 'Высота  изображения:';
...
$_['text_default_title'] = 'Отзывы о магазине';
