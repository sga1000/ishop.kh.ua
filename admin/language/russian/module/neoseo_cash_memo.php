...
$_['text_sku_asc'] = 'По артикулу (А - Я)';
$_['text_sku_desc'] = 'По артикулу (Я - А)';
...
$_['entry_client_side'] = 'Разрешить клиенту просмотр чека, в личном кабинете:';
$_['entry_store_text'] = 'Дополнительная информация о компании:';
$_['entry_invoice_status'] = 'Включить просмотр товарного чека';
$_['entry_product_order'] = 'Включить просмотр товарной накладной';
$_['entry_product_order_client'] = 'Разрешить клиенту просмотр товарной накладной, в личном кабинете:';
