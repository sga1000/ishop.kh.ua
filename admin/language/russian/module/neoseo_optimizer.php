...
$_['tab_cache_layout'] = 'Кеширование блоков';
...
$_['entry_use_layout_cache'] = 'Использовать кэш блоков Layout';
$_['entry_cache_exclude_modules'] = 'Модули которые не кешировать';
$_['entry_cache_exclude_modules_desc'] = 'Вводить по 1 имени модуля с новой строки. Имя модуля например neoseo_filter';
$_['entry_cache_need_path'] = 'Модули, которые кешировать в зависимости от route';
$_['entry_cache_need_path_desc'] = 'Вводить по 1 имени модуля с новой строки. Имя модуля например neoseo_filter';
