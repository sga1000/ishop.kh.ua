...
// Heading
$_['heading_title'] = '<img width="24" height="24" src="view/image/faviconI.png" style="margin-right: 10px;float: left;"><p style="margin:0;line-height: 24px;">&nbsp;Дерево категорий - Блок</p>';
$_['heading_title_raw'] = 'Дерево категорий - Блок';
...
$_['text_manual'] = 'Ручное';
$_['text_auto'] = 'Автоматическое';
$_['text_auto_child'] = 'Автоподбор подкатегорий';
...
$_['entry_categories_id'] = 'Набор категорий';
$_['entry_template'] = 'Выберите шаблон отображения';
$_['entry_icon_width'] = 'Ширина изображения';
$_['entry_icon_height'] = 'Высота изображения';
