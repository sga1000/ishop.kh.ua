...
class ControllerLocalisationCountry extends Controller {
	...
	protected function getList() {
		...
		$data['sort_iso_code_3'] = $this->url->link('localisation/country', 'token=' . $this->session->data['token'] . '&sort=iso_code_3' . $url, 'SSL');
			/* NeoSeo Checkout - begin */
			$data['sort_language_id'] = $this->url->link('localisation/country', 'token=' . $this->session->data['token'] . '&sort=language_id' . $url, 'SSL');
			/* NeoSeo Checkout - end */
	...
	protected function getForm() {
		...
		$data['footer'] = $this->load->controller('common/footer');
				...
				/* NeoSeo Checkout - begin */
		$this->response->setOutput($this->load->view('localisation/neoseo_country_form.tpl', $data));
		/* NeoSeo Checkout - end */
	}
