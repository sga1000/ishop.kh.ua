...
class ControllerModuleNeoSeoCategoryMenu extends NeoSeoController {
    ...
    public function index($setting) {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->model_setting_setting->editSetting('neoseo_category_menu', $globalModuleData);
		...
		$data = $this->initModuleParams(array(
            ...
            array($this->_moduleSysName . '_collapse', 1),
            array($this->_moduleSysName . '_hide', 1),
            array($this->_moduleSysName . '_show_only_child', 0),
            array($this->_moduleSysName . '_full_height', 0),
