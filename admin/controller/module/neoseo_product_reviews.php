...
class ControllerModuleNeoseoProductReviews extends NeoSeoController {
	...
	public function __construct($registry) {
		...
		$this->_moduleSysName = "neoseo_product_reviews";
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			foreach(range(1,10) as $index) {
				$this->cache->delete($this->_moduleSysName.$index);
			}
		...
		$data = $this->initModuleParams(array(
			...
			array($this->_moduleSysName . '_limit', 3),
