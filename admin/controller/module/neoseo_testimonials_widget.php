...
class ControllerModuleNeoseoTestimonialsWidget extends NeoSeoController
{
	...
	public function index()
	{
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
			...
			if(!isset($this->request->post[$this->_moduleSysName.'_method'])){
				$this->request->post[$this->_moduleSysName.'_method'] = array();
			}
		...
		$data['methods'] = array(
			'1' => $this->language->get('text_status_disabled'),
			'2' => $this->language->get('text_no_admin_answer'),
		);
