...
class ControllerModuleNeoSeoLastViewedProducts extends NeoSeoController
{
    ...
    public function index()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->model_setting_setting->editSetting('neoseo_last_viewed_products', $globalModuleData);
        ...
        $template_files = glob(DIR_CATALOG . 'view/theme/default/template/module/neoseo_last_viewed_products_*.tpl');
        if ($template_files) {
            foreach ($template_files as $template_file) {
                $template_file_name = str_replace("neoseo_last_viewed_products_", "", basename($template_file, '.tpl'));
