...
class ControllerSaleOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
			...
			$this->load->model('tool/neoseo_order_referrer');
			$data['first_referrer'] =  $this->model_tool_neoseo_order_referrer->decode( $order_info['first_referrer'], "detail" );
			$data['last_referrer'] =  $this->model_tool_neoseo_order_referrer->decode( $order_info['last_referrer'], "detail" );
			/* NeoSeo Order Referrer - end */
