...
class ControllerCommonFileManager extends Controller {
	...
	public function index() {
		...
		if($this->session->data['fm_sort_type'] == 'date'){
			foreach ($files as $file) {
				$fileList[$file] = filemtime($file);
			}
			arsort($fileList);
			$files = array_keys($fileList);
		}
		...
		$data['button_sort_name'] = $this->language->get('button_sort_name');
		$data['button_sort_date'] = $this->language->get('button_sort_date');
	...
	public function sort()
	{
		if(isset($this->request->post['type'])){
			$this->session->data['fm_sort_type'] = $this->request->post['type'];
		}
	}
}
