...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		if (!isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			/* NeoSeo Clear Cache - begin */
			$this->load->language('tool/neoseo_clear_cache');
			$data['text_logout'] = $this->language->get('text_logout');
			...
			$data['text_cache_filter'] = $this->language->get('text_cache_filter');
			/* NeoSeo Clear Cache - end */
			...
			/* Удаление демо данных проверка */
			$data['is_demo_data_removed'] = $this->config->get('is_demo_data_removed');
			$data['button_delete_demo_data'] = $this->language->get('button_delete_demo_data');
			$data['text_demo_data_delete'] = $this->language->get('text_demo_data_delete');
			$data['confirm_delete'] = $this->language->get('text_confirm_delete');
			$data['text_yes'] = $this->language->get('text_yes');
			$data['text_no'] = $this->language->get('text_no');
			$data['text_mute'] = $this->language->get('text_mute');
			...
			$data['demo_mute_demo_link'] = html_entity_decode($this->url->link('module/neoseo_unistor/muteDemoData', 'token=' . $this->session->data['token'] , 'SSL'));
