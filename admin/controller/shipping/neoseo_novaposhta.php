...
class ControllerShippingNeoseoNovaposhta extends NeoSeoController
{
	...
	public function index()
	{
		...
		$data['uphblink'] = $this->url->link($this->_route . '/' . $this->_moduleSysName() . '/updatehandbook', 'token=' . $this->session->data['token'], 'SSL');
