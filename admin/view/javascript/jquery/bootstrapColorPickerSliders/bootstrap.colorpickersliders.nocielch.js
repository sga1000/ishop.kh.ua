  ...
  $.fn.ColorPickerSliders = function(options) {
    ...
    return this.each(function() {
      ...
      function _getControllerHtml() {
        ...
        if (settings.swatches) {
          color_picker_html += '<div class="cp-swatches clearfix"><button type="button" class="add btn btn-default" title="' + settings.titleswatchesadd + '"><i class="fa fa-floppy-o" aria-hidden="true"></i></button><button type="button" class="remove btn btn-default" title="' + settings.titleswatchesremove + '"><i class="fa fa-trash" aria-hidden="true"></i></button><button type="button" class="reset btn btn-default" title="' + settings.titleswatchesreset + '"><i class="fa fa-repeat" aria-hidden="true"></i></button><ul></ul></div>';
        }
