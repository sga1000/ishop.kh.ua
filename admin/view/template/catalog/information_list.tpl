            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><a href="<?php echo HTTP_CATALOG; ?>index.php?route=information/information&information_id=<?php echo $information['information_id']; ?>" target="_new" data-toggle="tooltip" title="" class="btn btn-success" data-original-title="Перейти к товару на витрине"><i class="fa fa-eye"></i></a>
