  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <?php if( $product_id ) { ?>
        <a href="<?php echo HTTP_CATALOG; ?>index.php?route=product/product&product_id=<?php echo $product_id; ?>" target="_new" data-toggle="tooltip" title="" class="btn btn-success" data-original-title="Перейти к товару на витрине"><i class="fa fa-eye"></i></a>
        <?php } ?>
          <button type="button" onclick="$('#form-product').attr('action', $('#form-product').attr('action') + '&action=save_and_stay');$('#form-product').submit();" data-toggle="tooltip" title="<?php echo $button_save_and_stay; ?>" class="btn btn-success"><i class="fa fa-save"></i>&nbsp;<i class="fa fa-refresh"></i></button>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
				...
				<!-- SOFORP Product Order History - begin -->
				<div class="tab-pane" id="tab-orders"><?php echo $orders; ?></div>
				<!-- SOFORP Product Order History - begin -->
            ...
            <div class="tab-pane" id="tab-links">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label" for="input-product_labels"><?php echo $entry_product_labels; ?></label>
                <div class="col-sm-10">
                  <div class="well well-sm" style="min-height: 150px;max-height: 500px;overflow: auto;">
                    <table class="table table-striped">
                    ...
                    <tr>
                      <td class="checkbox">
                        <label>
                          <?php if (isset($product_id) && isset($label['products']) && in_array($product_id, $label['products'])) { ?>
                          <input type="checkbox" name="product_labels[]" value="<?php echo $label['label_id']; ?>" checked="checked" />
                          <?php echo $label['name']; ?>
                          <?php } else { ?>
                          <input type="checkbox" name="product_labels[]" value="<?php echo $label['label_id']; ?>" />
                          <?php echo $label['name']; ?>
                          <?php } ?>
                        </label>
                      </td>
