  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="<?php echo HTTP_CATALOG;?>index.php?route=information/information&information_id=<?php echo $information_id; ?>" target="_new"  data-toggle="tooltip" title="" class="btn btn-success" data-original-title="Перейти к информации на витрине"><i class="fa fa-eye"></i></a>
        <?php } ?>
