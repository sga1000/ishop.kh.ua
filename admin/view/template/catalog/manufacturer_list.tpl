            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><a href="<?php echo HTTP_CATALOG; ?>index.php?route=product/manufacturer&manufacturer_id=<?php echo $manufacturer['manufacturer_id']; ?>" target="_new" data-toggle="tooltip" title="" class="btn btn-success" data-original-title="Перейти к товару на витрине"><i class="fa fa-eye"></i></a>
                    <a href="<?php echo $manufacturer['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
