        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-option">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'od.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'bo.sort_order') { ?>
                    <a href="<?php echo $sort_sort_order; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_sort_order; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_sort_order; ?>"><?php echo $column_sort_order; ?></a>
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'bo.status') { ?>
              ...
              <tbody>
                <?php if ($options_pro) { ?>
                <?php foreach ($options_pro as $option) { ?>
                <tr>
                  <td class="text-center"><?php if (in_array($option['product_option_pro_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $option['product_option_pro_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $option['product_option_pro_id']; ?>" />
                    <?php } ?></td>
