...
$widgets = new SoforpWidgets('neoseo_product_options_pro_',$params);
                ...
                <form action="<?php echo $save; ?>" method="post" enctype="multipart/form-data" id="form">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <?php $widgets->dropdown('product_list_status',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                            <?php $widgets->dropdown('product_base_price',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
