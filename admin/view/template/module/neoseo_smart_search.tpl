...
$widgets = new NeoSeoWidgets('neoseo_smart_search_',$params);
                ...
                <form action="<?php echo $save; ?>" method="post" enctype="multipart/form-data" id="form">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <?php $widgets->dropdown('name_status',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                            <?php $widgets->dropdown('model_status',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                            <?php $widgets->dropdown('show_categories',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                            <?php $widgets->dropdown('sku_status',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                            <?php $widgets->input('product_limit'); ?>
                            ...
                            <?php $widgets->dropdown('price_status',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                            <?php $widgets->dropdown('rating_status',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                            <?php $widgets->input('description_limit'); ?>
                            <?php $widgets->input('selector'); ?>
