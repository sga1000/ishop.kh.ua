                ...
                <form action="<?php echo $save; ?>" method="post" enctype="multipart/form-data" id="form">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab-subscribe">
                            ...
                            <?php $widgets->localeTextarea('subscribe_text_subscribe',$full_languages); ?>
                        ...
                        <div class="tab-pane" id="tab-unsubscribe">
                            <?php $widgets->localeTextarea('unsubscribe_text_unsubscribe',$full_languages); ?>
...
<script type="text/javascript"><!--
    <?php foreach ($full_languages as $language) { ?>
            <?php if ($ckeditor) { ?>
                ckeditorInit('neoseo_notify_price_change_subscribe_text_subscribe<?php echo $language['language_id']; ?>', '<?php echo $token; ?>');
                ckeditorInit('neoseo_notify_price_change_subscribe_message<?php echo $language['language_id']; ?>', '<?php echo $token; ?>');
                ckeditorInit('neoseo_notify_price_change_unsubscribe_text_unsubscribe<?php echo $language['language_id']; ?>', '<?php echo $token; ?>');
                ckeditorInit('neoseo_notify_price_change_unsubscribe_message<?php echo $language['language_id']; ?>', '<?php echo $token; ?>');
                ckeditorInit('neoseo_notify_price_change_subscribe_message_mail<?php echo $language['language_id']; ?>', '<?php echo $token; ?>');
            <?php } else { ?>
                    $("#neoseo_notify_price_change_subscribe_text_subscribe<?php echo $language['language_id']?>").summernote({height: 300, lang:'ru-RU'});
                    $("#neoseo_notify_price_change_subscribe_message<?php echo $language['language_id']?>").summernote({height: 300, lang:'ru-RU'});
                    $("#neoseo_notify_price_change_unsubscribe_text_unsubscribe<?php echo $language['language_id']?>").summernote({height: 300, lang:'ru-RU'});
                    $("#neoseo_notify_price_change_unsubscribe_message<?php echo $language['language_id']?>").summernote({height: 300, lang:'ru-RU'});
                    $("#neoseo_notify_price_change_subscribe_message_mail<?php echo $language['language_id']?>").summernote({height: 300, lang:'ru-RU'});
            <?php } ?>
    <?php } ?>

    <?php if ($ckeditor) { ?>
        ckeditorInit('neoseo_notify_price_change_admin_subscribe_notify_message', '<?php echo $token; ?>');
        ckeditorInit('neoseo_notify_price_change_admin_unsubscribe_notify_message', '<?php echo $token; ?>');
    <?php } else { ?>
         $('#neoseo_notify_price_change_admin_subscribe_notify_message').summernote({height: 300, lang:'ru-RU'});
         $('#neoseo_notify_price_change_admin_unsubscribe_notify_message').summernote({height: 300, lang:'ru-RU'});
    <?php } ?>
            //-->
</script>
<?php echo $footer; ?>
