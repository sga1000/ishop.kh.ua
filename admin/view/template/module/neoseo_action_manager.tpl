                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <div class="form-group">
                                ...
                                <?php $widgets->localeInput('meta_title_ml', $languages); ?>
                                <?php $widgets->localeInput('meta_description_ml', $languages); ?>
                                <?php $widgets->localeInput('meta_keyword_ml', $languages); ?>
                                <?php $widgets->dropdown('brand_to_related',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                                <?php $widgets->dropdown('category_to_related',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                            </div>
