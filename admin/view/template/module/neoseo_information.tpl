...
$widgets = new NeoSeoWidgets('neoseo_information_',$params);
                ...
                <form action="<?php echo $save; ?>" method="post" enctype="multipart/form-data" id="form">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <?php $widgets->dropdown('information_id',$informations); ?>
                            <?php } else { ?>
...
<?php foreach ($full_languages as $language) { ?>
    <?php if (isset($ckeditor) && $ckeditor) { ?>
        ckeditorInit('neoseo_html_html_content<?php echo $language['language_id']; ?>', '<?php echo $token; ?>');
    <?php } else { ?>
        $('#neoseo_html_html_content<?php echo $language['language_id']; ?>').summernote({height: 300});
    <?php } ?>
<?php } ?>
