...
$widgets = new NeoSeoWidgets('neoseo_callback_',$params);
...
<?php if ($ckeditor) { ?>
    ckeditorInit("neoseo_callback_message<?php echo $language['language_id']?>", '<?php echo $token; ?>');
<?php } else { ?>
    $("#neoseo_callback_message<?php echo $language['language_id']?>").summernote({height: 300, lang:'ru-RU'});
<?php } ?>
<?php } ?>
<?php if ($ckeditor) { ?>
    ckeditorInit("neoseo_callback_notify_message", '<?php echo $token; ?>');
<?php } else { ?>
    $("#neoseo_callback_notify_message").summernote({height: 300, lang:'ru-RU'});
<?php } ?>
//--></script>
