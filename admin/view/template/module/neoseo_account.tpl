...
$widgets = new NeoSeoWidgets('neoseo_account_',$params);
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <?php if( !isset($license_error) ) { ?>
                                ...
                                <?php $widgets->dropdown('social_status',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                                <?php $widgets->dropdown('social_sort', $social_auth_sort); ?>
                                <?php $widgets->localeInput('social_title', $languages); ?>
                                <?php $widgets->checklist('social_networks', $param_social_networks); ?>
                            <?php } else { ?>
