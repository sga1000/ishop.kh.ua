...
$widgets = new NeoseoWidgets('neoseo_bestseller_',$params);
        ...
        <form action="<?php echo $save; ?>" method="post" enctype="multipart/form-data" id="form">
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <?php $widgets->dropdown('use_image',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
              <div class="form-group" style="display: inline-block; width: 100%;">
                ...
                <div class="col-sm-7">
                  <a href="" id="infoblock-image" data-toggle="image" class="img-thumbnail" ><img style="max-width:100px; max-height: 100px;" src="<?php echo $block_image; ?>" alt="" title="" data-placeholder="<?php echo $image_placeholder; ?>" /></a>
                  <input type="hidden" name="<?php echo $sysname; ?>_image" value="<?php echo ${$sysname . '_image'}; ?>" id="input-image" />
                </div>
              </div>
