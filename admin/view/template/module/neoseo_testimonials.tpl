...
$widgets = new NeoSeoWidgets('neoseo_testimonials_',$params);
                ...
                <form action="<?php echo $save; ?>" method="post" enctype="multipart/form-data" id="form">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <?php $widgets->dropdown('youtube',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                            <?php $widgets->dropdown('user_image_status',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                            <?php $widgets->input('user_image_width'); ?>
                            <?php $widgets->input('user_image_height'); ?>
