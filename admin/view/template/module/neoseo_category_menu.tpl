...
$widgets = new NeoSeoWidgets('neoseo_category_menu_',$params);
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
                                ...
                                <?php if( !isset($license_error) ) { ?>
                                    ...
                                    <?php $widgets->dropdown('collapse',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                                    <?php $widgets->dropdown('hide',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                                    <?php $widgets->dropdown('show_only_child',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
