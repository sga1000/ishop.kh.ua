...
$widgets = new NeoseoWidgets('neoseo_slideshow_',$params);
                ...
                <form action="<?php echo $save; ?>" method="post" enctype="multipart/form-data" id="form">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <?php $widgets->dropdown('banner',$banners); ?>
                            <?php $widgets->input('width'); ?>
                            <?php $widgets->input('height'); ?>
                            <?php $widgets->dropdown('banner2',$banners); ?>
                            <?php $widgets->input('width2'); ?>
                            <?php $widgets->input('height2'); ?>
