                ...
                <form action="<?php echo $save; ?>" method="post" enctype="multipart/form-data" id="form">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <?php $widgets->dropdown('show_review_number',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                            ...
                            <?php $widgets->dropdown('show_product',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
                            <?php $widgets->dropdown('show_product_image',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
