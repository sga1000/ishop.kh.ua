                ...
                <form action="<?php echo $save; ?>" method="post" enctype="multipart/form-data" id="form">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <?php $widgets->input('sms_length'); ?>
                            <?php $widgets->input('password_lifetime'); ?>
                            <?php $widgets->input('times_before_ban'); ?>
                            <?php $widgets->input('ban_time'); ?>
                            <?php $widgets->input('mask'); ?>
                            <?php $widgets->dropdown('captcha',$captchas); ?>
