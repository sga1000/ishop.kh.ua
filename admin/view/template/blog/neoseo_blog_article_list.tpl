...
<div id="content">
	...
	<div class="container-fluid">
		...
		<button type="button" data-toggle="tooltip" title="<?php echo $button_copy; ?>" class="btn btn-default" onclick="$('#form-blog-article').attr('action', '<?php echo $copy; ?>').submit()"><i class="fa fa-copy"></i></button>
	...
	<div class="panel panel-default">
		...
		<div class="well">
			...
			<div class="col-sm-6">
				...
				<input type="text" name="filter_name" value="<?php echo $filter_name; ?>" placeholder="<?php echo $column_article_name; ?>" id="input-name" class="form-control" />
				</div>
			</div>
			<div class="col-sm-6">
				<div class="form-group">
			...
			<div class="col-sm-4">
				<div class="form-group">
				<label class="control-label" for="input-status"><?php echo $column_author_name; ?></label>
				<select name="filter_author" id="input-status" class="form-control">
					<option value="*"></option>
		...
		<form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-blog-article">
			...
			<table class="table table-bordered table-hover">
				...
				<tr>
					...
					<a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_article_name; ?></a>
					<?php } else { ?>
					<a href="<?php echo $sort_name; ?>"><?php echo $column_article_name; ?></a>
					<?php } ?>
					</td>
				...
				<tr>
					...
					<?php if (in_array($article['article_id'], $selected)) { ?>
					...
					<td class="text-right">
					<?php foreach ($categories as $category) { ?>
					<?php if (in_array($category['category_id'], $article['categories'])) { ?>
...
$('#button-filter').on('click', function () {
	var url = 'index.php?route=blog/neoseo_blog_article&token=<?php echo $token; ?>';
	...
	var filter_author = $('select[name=\'filter_author\']').val();
