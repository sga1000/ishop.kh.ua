            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                ...
                <td class="text-left">
                  ...
                  <div class="input-group pull-left"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> </span>
                    <input type="text" name="banner_image[<?php echo $image_row; ?>][link][<?php echo $language['language_id']; ?>]" value="<?php echo (isset($banner_image['banner_image_description'][$language['language_id']]) ? $banner_image['banner_image_description'][$language['language_id']]['link'] : ''); ?>" placeholder="<?php echo $entry_link; ?>" class="form-control" />
                  </div>
                  <?php } ?>
                </td>
                <td class="text-left">
                  <?php foreach ($languages as $language) { ?>
                  <div class="input-group pull-left"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> </span>
                    <a href="" id="thumb-image<?php echo $image_row.'-'.$language['language_id']; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $banner_image['banner_image_description'][$language['language_id']]['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
...
<?php foreach ($languages as $language) { ?>
        ...
        html += '<input type="text" name="banner_image[' + image_row + '][link][<?php echo $language['language_id']; ?>]" value="" placeholder="<?php echo $entry_link; ?>" class="form-control" />';
        html += '</div>';
    <?php } ?>
...
<?php foreach ($languages as $language) { ?>
        html += '<div class="input-group pull-left"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> </span>';
        html += '<a href="" id="thumb-image' + image_row + '-<?php echo $language['language_id']; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="banner_image[' + image_row + '][image][<?php echo $language['language_id']; ?>]" value="" id="input-image' + image_row + '-<?php echo $language['language_id']; ?>" />';
        html += '</div>';
    <?php } ?>

    html += '</td>';html += '  <td class="text-right" style="width: 10%;"><input type="text" name="banner_image[' + image_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
