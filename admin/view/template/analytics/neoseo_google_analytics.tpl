...
$widgets = new NeoSeoWidgets('neoseo_google_analytics_', $params);
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-general">
                                <?php if (!isset($license_error)) { ?>
                                    ...
                                    <?php $widgets->inputMultiStore($stores, 'remarketing'); ?>
                                    <?php $widgets->dropdownMultiStore($stores, 'ecommerce', array(0 => $text_disabled, 1 => $text_enabled)); ?>
                                <?php } else { ?>
