            ...
            <div class="panel-body">
                <div class="well">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                             <div class="form-group">
                                <label class="control-label" for="input-name_product"><?php echo $entry_name_product; ?></label>
                                <input type="text" name="filter_product_name" value="<?php echo $filter_product_name; ?>" placeholder="<?php echo $entry_name_product; ?>" id="input-model" class="form-control" />
                            </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left" ><a href="<?php echo  $item['product_url']; ?>" target="_blank"><?php echo $item['product_name']; ?></a></td>
                                </tr>
                                <?php } ?>
                                <?php } else { ?>
                                <tr>
...
<script type="text/javascript">
    $('#button-filter').on('click', function () {
        var url = 'index.php?route=sale/neoseo_notify_price_change&token=<?php echo $token; ?>';
