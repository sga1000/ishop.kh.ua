        ...
        <div class="panel panel-default">
          ...
          <table class="table">
            <tbody>
              ...
              <!-- NeoSeo Checkout - begin -->
				<?php if(isset($data['sc_fields']['shipping'])) foreach($data['sc_fields']['shipping'] as $item) { ?>
			<tr>
				<td><?php echo $item['name']; ?></td>
				<td><?php echo $item['value']; ?></td>
			</tr>
			<?php } ?>
			<?php if(isset($data['sc_fields']['payment'])) foreach($data['sc_fields']['payment'] as $item) { ?>
			<tr>
				<td><?php echo $item['name']; ?></td>
				<td><?php echo $item['value']; ?></td>
			</tr>
