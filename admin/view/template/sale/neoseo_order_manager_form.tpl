    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <?php if(!$hide):?>
                <button type="button" id="button-refresh_full" data-toggle="tooltip" title="<?php echo $button_refresh; ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-warning"><i class="fa fa-refresh"></i></button>
                <?php endif;?>
                <input type="hidden" id="button-refresh" data-toggle="tooltip" title="<?php echo $button_refresh; ?>" data-loading-text="<?php echo $text_loading; ?>">
                <button type="button" id="button-save" class="btn btn-primary"><i class="fa fa-save"></i> <?php echo $button_save; ?></button>
                <button type="button" id="button-save-and-close" class="btn btn-default"><i class="fa fa-save"></i> <?php echo $button_save_and_close; ?></button>
                <a href="<?php echo $cancel; ?>" class="btn btn-default"><i class="fa fa-close"></i> <?php echo $button_close; ?></a></div>
            ...
            <div class="panel-body">
                <form class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="row">
                            <div class="col-md-4 text-left">
                                ...
                                <div class="nav nav-tabs"><strong>1. <?php echo $tab_customer; ?></strong></div>
                                <div class="tab-pane active" id="tab-customer">
                                    ...
                                    <?php if(isset($tax_setting) && $tax_setting){ ?>
                                    <div class="form-group required">
                                        <label class="col-sm-4 control-label" for="input-tax-status"><?php echo $entry_tax_status; ?></label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <select name="tax_status" id="input-tax-status" class="form-control">
                                                    <?php if ($tax_ignore) { ?>
                                                    <option value="1" selected="selected"><?php echo $text_tax_status_yes; ?></option>
                                                    <option value="0"><?php echo $text_tax_status_not; ?></option>
                                                    <?php }else{ ?>
                                                    <option value="1" ><?php echo $text_tax_status_yes; ?></option>
                                                    <option value="0" selected="selected"><?php echo $text_tax_status_not; ?></option>
                                                    <?php } ?>
                                                </select>
                      <span class="input-group-btn">
                      <button type="button" id="button-tax-status" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><?php echo $button_apply; ?></button>
                      </span></div>
                                        </div>
                                    </div>
                                    <?php } ?>
                    ...
                    <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                            ...
                            <div class="col-md-4 text-left">
                                <div class="nav nav-tabs"><strong>2. <?php echo $tab_shipping; ?></strong></div>
                                <div class="tab-pane active" id="tab-shipping">

                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="input-shipping-address"><?php echo $entry_address; ?></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group required">
                                        <label class="col-sm-4 control-label" for="input-shipping-country"><?php echo $entry_country; ?></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group required">
                                        <label class="col-sm-4 control-label" for="input-shipping-zone"><?php echo $entry_zone; ?></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group required">
                                        <label class="col-sm-4 control-label" for="input-shipping-city"><?php echo $entry_city; ?></label>
                                        <div class="col-sm-8">
                                            <input type="text" name="city" value="<?php echo $shipping_city; ?>" id="input-shipping-city" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        <label class="col-sm-4 control-label" for="input-shipping-address-1"><?php echo $entry_address_1; ?></label>
                                        <div class="col-sm-8">
                                            <input type="text" name="address_1" value="<?php echo $shipping_address_1; ?>" id="input-shipping-address-1" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="input-shipping-address-2"><?php echo $entry_address_2; ?></label>
                                        <div class="col-sm-8">
                      ...
                      <button type="button" id="button-shipping-method" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><?php echo $button_apply; ?></button>
                                    ...
                                    <?php if(!$hide):?>
                                    <div class="form-group required">
                                        <label class="col-sm-4 control-label" for="input-shipping-firstname"><?php echo $entry_firstname; ?></label>
                                        <div class="col-sm-8">
                                            <?php endif;?>
                                            <??>
                                            <input type="<?php echo $hide?'hidden':'text'; ?>" name="firstname" value="<?php echo $firstname; ?>" id="input-shipping-firstname" class="form-control" />
                                            <?php if(!$hide):?>
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        <label class="col-sm-4 control-label" for="input-shipping-lastname"><?php echo $entry_lastname; ?></label>
                                        <div class="col-sm-8">
                                            <?php endif;?>
                                            <input type="<?php echo $hide?'hidden':'text'; ?>" name="lastname" value="<?php echo $lastname; ?>" id="input-shipping-lastname" class="form-control" />
                                            <?php if(!$hide):?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="input-shipping-company"><?php echo $entry_company; ?></label>
                                        <div class="col-sm-8">
                    ...
                    <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                            ...
                            <div class="col-md-4 text-left">
                                <div class="nav nav-tabs"><strong>3. <?php echo $tab_payment; ?></strong></div>
                                <div class="tab-pane active" id="tab-total">
                                    <fieldset>
                                        <?php if(!$hide):?><legend><?php echo $text_order_detail; ?></legend><?php endif;?>
                                        <div class="form-group required">
                      ...
                      <button type="button" id="button-reward" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><?php echo $button_apply; ?></button>
                                ...
                                <?php if(isset($scfields) && $scfields){ ?>
                                <div class="nav nav-tabs"><strong>4. <?php echo $tab_order_scfields; ?></strong></div>
                                <div class="tab-pane active" id="tab-customer2">
                                    <?php foreach($scfields as $field_id => $field){ ?>

                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="input-scfields"><?php echo $field['label'][$language_id]; ?></label>
                                        <div class="col-sm-8">
                                            <input type="text" name="scfields[<?php echo $field_id ?>]" value="<?php echo $field['value']; ?>" id="input-scfields" class="form-control" />
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="tab-pane <?php echo $hide?'':'active'; ?>" id="tab-payment">
                        <div class="not-show" id="not-show-hidden">

                            <?php if(count($stores)==1):?>
                            <select name="store" id="input-store">
                                <option value="<?php echo $stores[0]['href']; ?>" selected="selected"></option>
                            </select>
                            <?php endif;?>
                            <?php if(count($currencies)==1):?>
                            <select name="currency" id="input-currency">
                                <?php foreach ($currencies as $currency) { ?>
                                <?php if ($currency['code'] == $currency_code) { ?>
                                <option value="<?php echo $currency['code']; ?>" selected="selected"></option>
                                <?php } else { ?>
                                <option value="<?php echo $currency['code']; ?>"></option>
                                <?php } ?>
                                <?php } ?>
                            </select>
                            <?php endif;?>
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="lastname" value="<?php echo $lastname; ?>" id="input-payment-lastname" class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript"><!--
    var catalog = $('select[name=\'store\'] option:selected').val();
    ...
    $('select[name=\'currency\']').on('change', function() {
        $.ajax({
            url: catalog + 'index.php?route=api/currency&token=' + token,
            type: 'post',
    ...
    //            $.ajax({
    //                url: catalog + 'index.php?route=api/customer&token=' + token,
    //                type: 'post',
    ...
    //                        var request_1 = $.ajax({
    //                            url: catalog + 'index.php?route=api/cart/add&token=' + token,
    //                            type: 'post',
    ...
    //                            $.ajax({
    //                                url: catalog + 'index.php?route=api/voucher/add&token=' + token,
    //                                type: 'post',
        ...
        $.ajax({
            ...
            success: function(json) {
                ...
                if (json['error']) {
                    ...
                    // Refresh products, vouchers and totals
                    press_button_refresh(press_button_customer);
                    //$('#button-refresh').trigger('click');
                }
            },
            error: function(xhr, ajaxOptions, thrownError) {
    ...
    $('#cart').delegate('.btn-danger', 'click', function() {
        ...
        $.ajax({
            url: catalog + 'index.php?route=api/cart/remove&token=' + token,
            type: 'post',
            ...
            success: function(json) {
                ...
                if (json['error']) {
                    ...
                    press_button_shipping_address(token, save = false);
                    // Refresh products, vouchers and totals
                    $('#button-refresh').trigger('click');
                }
            },
    ...
    $('#button-payment-address').on('click', function() {
        $.ajax({
            url: catalog + 'index.php?route=api/payment/address&token=' + token,
            type: 'post',
            ...
            success: function(json) {
                ...
                if (json['error']) {
                    ...
                    // Payment Methods
                    $.ajax({
                        url: catalog + 'index.php?route=api/payment/methods&token=' + token,
                        dataType: 'json',
                        crossDomain: true,
                        beforeSend: function() {
                                    ...
                                    for (i in json['payment_methods']) {
                                        if (json['payment_methods'][i]['quote']) {
                                            ...
                                            for (j in json['payment_methods'][i]['quote']) {
                                                if (json['payment_methods'][i]['quote'][j]['code'] == $('select[name=\'payment_method\'] option:selected').val()) {
    ...
    $('select[name=\'shipping_address\']').on('change', function() {
        $.ajax({
            ...
            success: function(json) {
                ...
                $('#tab-shipping input[name=\'firstname\']').val($('#tab-customer input[name=\'firstname\']').val());
                $('#tab-shipping input[name=\'lastname\']').val($('#tab-customer input[name=\'lastname\']').val());
                ...
                //Add to payment_address tab-payment

                $('#tab-payment input[name=\'firstname\']').val($('#tab-customer input[name=\'firstname\']').val());
                $('#tab-payment input[name=\'lastname\']').val($('#tab-customer input[name=\'lastname\']').val());
                $('#tab-payment input[name=\'company\']').val(json['company']);
                $('#tab-payment input[name=\'address_1\']').val(json['address_1']);
                $('#tab-payment input[name=\'address_2\']').val(json['address_2']);
                $('#tab-payment input[name=\'city\']').val(json['city']);
    ...
    $('#tab-shipping select[name=\'country_id\']').on('change', function() {
        $.ajax({
            ...
            success: function(json) {
                ...
                $('#tab-payment select[name=\'country_id\']').val($('#tab-shipping select[name=\'country_id\']').val());
                $('#tab-payment select[name=\'zone_id\']').html(html);
            },
            error: function(xhr, ajaxOptions, thrownError) {
                alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
    ...
    $('#tab-shipping select[name=\'zone_id\']').on('change', function() {
        ...
        $('#tab-payment select[name=\'zone_id\']').val($('#tab-shipping select[name=\'zone_id\']').val());
        press_button_customer(token);

    });
    $('#tab-shipping input[name=\'city\']').on('change', function() {

        $('#tab-payment input[name=\'city\']').val($('#tab-shipping input[name=\'city\']').val());
        press_button_customer(token);

    });
    $('#tab-shipping input[name=\'address_1\']').on('change', function() {

        $('#tab-payment input[name=\'address_1\']').val($('#tab-shipping input[name=\'address_1\']').val());
        press_button_customer(token);

    });

    $('#tab-customer input[name=\'lastname\']').on('change', function() {

        $('#tab-shipping input[name=\'lastname\']').val($('#tab-customer input[name=\'lastname\']').val());
        $('#tab-payment input[name=\'lastname\']').val($('#tab-customer input[name=\'lastname\']').val());

    });
    $('#tab-customer input[name=\'firstname\']').on('change', function() {
    ...
    $('#button-shipping-address').on('click', function() {
        $.ajax({
            url: catalog + 'index.php?route=api/shipping/address&token=' + token,
            type: 'post',
            ...
            success: function(json) {
                ...
                if (json['error']) {
                    ...
                    // Shipping Methods
                    var request = $.ajax({
                        url: catalog + 'index.php?route=api/shipping/methods&token=' + token,
                        dataType: 'json',
                        beforeSend: function() {
    ...
    $('#button-shipping-method').on('click', function() {
        press_button_customer(token, save = false, method = true);
    });

    $('#button-tax-status').on('click', function() {
        press_button_customer(token, save = false, method = true);
    });
    ...
    $('#button-payment-method').on('click', function() {
        $.ajax({
            url: catalog + 'index.php?route=api/payment/method&token=' + token,
            type: 'post',
    ...
    $('#button-coupon').on('click', function() {
        $.ajax({
            url: catalog + 'index.php?route=api/coupon&token=' + token,
            type: 'post',
    ...
    $('#button-voucher').on('click', function() {
        $.ajax({
            url: catalog + 'index.php?route=api/voucher&token=' + token,
            type: 'post',
    ...
    $('#button-reward').on('click', function() {
        $.ajax({
            url: catalog + 'index.php?route=api/reward&token=' + token,
            type: 'post',
    ...
    function ajax_api_login(save, method, close){
            ...
            success: function(json) {
                ...
                if (json['error']) {
                    ...
                    if (json['token']) {
                        ...
                        press_button_customer(token, save, method, close);
    ...
    function press_button_customer(token, save, method, close){
        $.ajax({
            url: catalog + 'index.php?route=api/customer&token=' + token,
            type: 'post',
            data: $('#tab-customer input[type=\'text\'], #tab-customer input[type=\'hidden\'], #tab-customer input[type=\'radio\']:checked, #tab-customer input[type=\'checkbox\']:checked, #tab-customer select, #tab-customer textarea'),
                        ...
                        $.ajax({
                            ...
                            success: function(json) {
                                ...
                                if (json['error'] && json['error']['warning']) {
                                    ...
                                    press_button_shipping_address(token, save, method, close);
                                }
                            },
                            error: function(xhr, ajaxOptions, thrownError) {
                                alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
    ...
    function press_button_payment_address(token, save, method, close) {
        $.ajax({
            url: catalog + 'index.php?route=api/payment/address&token=' + token,
            type: 'post',
            data: $('#tab-payment input[type=\'text\'], #tab-payment input[type=\'hidden\'], #tab-payment input[type=\'radio\']:checked, #tab-payment input[type=\'checkbox\']:checked, #tab-payment select, #tab-payment textarea'),
                    ...
                    $.ajax({
                        ...
                        success: function(json) {
                            if (json['error']) {
                                ...
                                if (typeof method == 'boolean' && method){
                                    press_button_shipping_method(token, save, close);
                                }
    ...
    function press_button_shipping_address(token, save, method, close) {
        $.ajax({
            url: catalog + 'index.php?route=api/shipping/address&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
            type: 'post',
            data: $('#tab-shipping input[type=\'text\'], #tab-shipping input[type=\'hidden\'], #tab-shipping input[type=\'radio\']:checked, #tab-shipping input[type=\'checkbox\']:checked, #tab-shipping select, #tab-shipping textarea'),
            dataType: 'json',
            crossDomain: true,
            ...
            success: function(json) {
                ...
                if (json['error']) {
                    ...
                    // Shipping Methods
                    var request = $.ajax({
                        url: catalog + 'index.php?route=api/shipping/methods&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
                        dataType: 'json',
                        beforeSend: function() {
                            $('#button-shipping-address').button('loading');
                        },
                        ...
                        success: function(json) {
                            if (json['error']) {
                                ...
                                press_button_payment_address(token, save, method, close);
                            }
                        },
                        error: function(xhr, ajaxOptions, thrownError) {
                            alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
    ...
    function press_button_shipping_method(token, save, close) {
        $.ajax({
            url: catalog + 'index.php?route=api/shipping/method&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
            type: 'post',
    ...
    function press_button_save(token, close) {
        var tax_status = $('#input-tax-status option:selected').val();
        var ignore = <?php if(isset($tax_ignore) && $tax_ignore){ echo (" '&ignore=1';"); } else {echo ("'';");}?>
        ...
        if ($('input[name=\'order_id\']').val() == 0) {
            var url = catalog + 'index.php?route=api/order/add&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val() +ignore;
        } else {
            var url = catalog + 'index.php?route=api/order/edit&token=' + token + '&store_id=' + $('select[name=\'store_id\'] option:selected').val() + '&order_id=' + $('input[name=\'order_id\']').val()+ignore;
        }

        var dataset = {
            'payment_method' : $('select[name=\'payment_method\'] option:selected').val(),
            'shipping_method': $('select[name=\'shipping_method\'] option:selected').val(),
            'order_status_id': $('#tab-total select[name=\'order_status_id\']').val(),
            'comment': $('#tab-total textarea[name=\'comment\']').val(),
            'affiliate_id': $('#tab-total textarea[name=\'affiliate_id\']').text(),
        };

        $('#tab-total select').each(function(){
        ...
        $.ajax({
            ...
            beforeSend: function() {
                if(close){
                    $('#button-save-and-close').button('loading');
                }else{
            ...
            complete: function() {
                if(close){
                    $('#button-save-and-close').button('reset');
                }else{
        ...
        if( $('input[name^=\'scfields\']').val() ){
            $.ajax({
                url: '<?php echo htmlspecialchars_decode($save_scfield_url); ?>',
                type: 'post',
                data: $('input[name^=\'scfields\'], input[name=\'order_id\']'),
                dataType: 'json',
                crossDomain: true,
                success: function (json) {
    ...
    $('#button-refresh_full').on('click', function() {
        press_button_customer(token,save=false);
    });

    $('#button-save-and-close').on('click', function() {
        press_button_customer(token, save=true, method = false, close = true);
    });

    // Checkout and Save
    $('#button-save').on('click', function() {
        press_button_customer(token, save = true, method = true);
    });

    // Checkout, Save and Close
    $('#button-save-and-close').on('click', function() {
        press_button_customer(token, save = true, method = true, close =true);
    });
    // Add all products to the cart using the api  url: catalog + 'index.php?route=api/cart/products&token=' + token,

    $('#button-refresh').on('click', press_button_refresh);

    function press_button_refresh(callback) {
        $('.tooltip').remove();
        ...
        $.ajax({
            url: catalog + 'index.php?route=api/cart/products&token=' + token + ignore,
            dataType: 'json',
            crossDomain: true,
            success: function(json) {
                ...
                if (json['products'].length) {
                    for (i = 0; i < json['products'].length; i++) {
                        ...
                        html += '<tr>';
                        html += '  <td class="text-left">' + product['name'] + ' ' + (!product['stock'] ? '<span style="color: #f56b6b;">***</span>' : '') + '<br />';
    ...
    //--></script>
<script type="text/javascript">
    <?php //require_once('./view/javascript/ajax.js');?>
</script>
<script type="text/javascript">
