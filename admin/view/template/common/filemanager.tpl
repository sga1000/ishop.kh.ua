    ...
    <div class="modal-body">
      <div class="row">
        <div class="col-sm-5"><a href="<?php echo $parent; ?>" data-toggle="tooltip" title="<?php echo $button_parent; ?>" id="button-parent" class="btn btn-default"><i class="fa fa-level-up"></i></a> <a href="<?php echo $refresh; ?>" data-toggle="tooltip" title="<?php echo $button_refresh; ?>" id="button-refresh" class="btn btn-default"><i class="fa fa-refresh"></i></a>
          ...
          <button type="button" data-toggle="tooltip" title="<?php echo $button_sort_name; ?>" id="button-sort-name" class="btn btn-info"><i class="fa fa-sort-alpha-asc"></i></button>
          <button type="button" data-toggle="tooltip" title="<?php echo $button_sort_date; ?>" id="button-sort-time" class="btn btn-info"><i class="fa fa-clock-o"></i></button>
        </div>
        <div class="col-sm-7">
...
$('#modal-image #button-delete').on('click', function(e) {
  ...
  $('#button-sort-name').on('click', function(e) {
    $.ajax({
      url: 'index.php?route=common/filemanager/sort&token=<?php echo $token; ?>',
      type: 'post',
      data: {'type':'name'},
      success: function(json) {
  ...
  $('#button-sort-time').on('click', function(e) {
    $.ajax({
      url: 'index.php?route=common/filemanager/sort&token=<?php echo $token; ?>',
      type: 'post',
      data: {'type':'date'},
