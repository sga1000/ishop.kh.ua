                          ...
                          <?php } else  {?>
                            ...
                            <?php foreach ($languages as $key => $language) { ?>
                              ...
                              <?php foreach ($languages as $key => $language) { ?>
                                ...
                                <label class="input-group-addon" for="input-short-name-<?php echo $language['language_id']; ?>"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" />&nbsp;&nbsp;&nbsp;<?php echo $language['name']; ?></label>
                                ...
                                <?php if (isset($error_short_name[$language['language_id']])) { ?>
                                  ...
                                  <div class="form-group required">
                                    ...
                                    <div class="col-sm-7 col-sm-offset-1">
                                      <div class="input-group">
                                        <label class="input-group-addon" for="input-long-name-<?php echo $language['language_id']; ?>"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" />&nbsp;&nbsp;&nbsp;<?php echo $language['name']; ?></label>
                                  ...
                                  <div class="form-group required">
                                    ...
                                    <div class="col-sm-7 col-sm-offset-1">
                                      <div class="input-group">
                                        <label class="input-group-addon" for="input-description-<?php echo $language['language_id']; ?>"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" />&nbsp;&nbsp;&nbsp;<?php echo $language['name']; ?></label>
