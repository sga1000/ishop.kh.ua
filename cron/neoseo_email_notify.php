...
{
	file_put_contents(DIR_LOGS . "neoseo_email_notify.log", date("Y-m-d H:i:s - ") . " " . $message . "\r\n", FILE_APPEND);
}
...
log1("================================================================");
log1("Отправка писем по крону - начало");
log1("================================================================");

// Router
$request = $registry->get('request');
$loader->model("module/neoseo_email_notify");

$result = $registry->get('model_module_neoseo_email_notify')->cronEmailNotify();

log1("===================================================================");
log1("Отправка писем по крону завершено");
log1("===================================================================");
?>
