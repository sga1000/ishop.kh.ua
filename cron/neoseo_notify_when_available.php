...
} else if (is_file(dirname(__FILE__) . "/../admin/config.php")) {
...
{
	file_put_contents(DIR_LOGS . "neoseo_notify_when_available.log", date("Y-m-d H:i:s - ") . $message . "\r\n", FILE_APPEND);
}
...
$loader->model("sale/neoseo_notify_when_available");
$result = $registry->get("model_sale_neoseo_notify_when_available")->processRequest();
