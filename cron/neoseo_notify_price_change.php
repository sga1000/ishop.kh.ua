...
{
	file_put_contents(DIR_LOGS . "neoseo_notify_price_change.log", date("Y-m-d H:i:s - ") . $message . "\r\n", FILE_APPEND);
}
...
$loader->model("sale/neoseo_notify_price_change");
$result = $registry->get("model_sale_neoseo_notify_price_change")->checkPriceChange();
