...
class NeoSeoPageCache {
    ...
    public function __construct($registry) {
        ...
        $log = new Log($this->_logFile);
        $registry->set('log', $log);
        $this->log = $registry->get('log');

        $skip_urls = $this->config->get($this->_moduleSysName . "_cache_url_limit");
        if($skip_urls){
            foreach (explode("\n", $skip_urls) as $line) {
                $this->skip_urls[] = trim($line);
            }
        }

        $this->expire = $this->config->get($this->_moduleSysName . "_expire_cache");
        ...
        $this->cachefolder=DIR_CACHE. 'neoseo_page_cache/';
