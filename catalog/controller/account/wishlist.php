...
class ControllerAccountWishList extends Controller {
	public function index() {
		...
		/* NeoSeo Account - begin */
		if ( $this->config->get('neoseo_account_status') ) {
			return new Action('account/neoseo_wishlist');
		}
		/* NeoSeo Account - end */
	...
	public function add() {
		...
		if ($this->config->get('neoseo_popup_wishlist_status') == 1) {
			$this->load->model("module/neoseo_popup_wishlist");
			$json = $this->model_module_neoseo_popup_wishlist->getPopup($product_info,$json);
		}
