...
class ControllerAccountNeoSeoLogin extends NeoSeoController
{
	...
	public function index()
	{
		...
		$this->load->language('account/neoseo_login');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('account/neoseo_login', '', 'SSL')
		);
		...
		$data['action'] = $this->url->link('account/neoseo_login', '', 'SSL');
		$data['register'] = $this->url->link('account/neoseo_register', '', 'SSL');
		$data['forgotten'] = $this->url->link('account/neoseo_forgotten', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/neoseo_account_login.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/account/neoseo_account_login.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/account/neoseo_account_login.tpl', $data));
		}
	}
