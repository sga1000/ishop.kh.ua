 ...
 */
class ControllerFeedYandexLite extends Controller {
	...
	public function index() {
		...
		$this->load->model('feed/yandex_lite');
		...
		$categories = $this->model_feed_yandex_lite->getCategories();
		...
		$products = $this->model_feed_yandex_lite->getProducts();
