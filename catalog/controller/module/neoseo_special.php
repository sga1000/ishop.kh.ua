...
class ControllerModuleNeoseoSpecial extends NeoSeoController
{
	...
	public function index($setting)
	{
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/neoseo_special_' . $template . '.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/neoseo_special_' . $template . '.tpl', $data);
		} else {
			return $this->load->view('default/template/module/neoseo_special_' . $template . '.tpl', $data);
		}
	}
