...
class ControllerExtensionFeedGoogleLite extends Controller {
	...
	public function index() {
		...
		$this->load->model('extension/feed/google_lite');
		...
		$products = $this->model_extension_feed_google_lite->getProducts();
