<div class="sidebar-category-accordeon<?= $collapse == 1 ? ' is-collapsed' : '';?><?= $hide == 1 ? ' collaps' : '';?><?= $full_height == 1 ? ' full-height' : '';?>">
...
<script>
    ...
    $(".sidebar-category-accordeon .dropmenu li").has("ul").append('<span class="icon"></span>');
    ...
    $('.sidebar-category-accordeon .activeicon > .icon').addClass('active');
    $('.sidebar-category-accordeon .active > .icon').addClass('active');
