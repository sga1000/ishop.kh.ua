        ...
        <div class="modal-content">
            <form id="notifyWhenAvailable">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php if(isset($option_key) && $option_title){ ?>
                               <input type="hidden" name="options" value="<?php echo $option_key;?>">
                                <h5><?php echo $option_title; ?></h5>
                            <?php } ?>
                ...
                <div class="modal-footer">
                    ...
                    <a onclick="processNotifyWhenAvailable()" class="btn btn-primary"><?php echo $button_action; ?></a>
                </div>
            </form>
        </div>
    </div>
