          ...
          <div class="product-thumb">
            ...
            <div>
              ...
              <div class="button-group">
                ...
                <button type="button" class="quick_order" onclick="showQuickOrder('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_quick_order; ?></span></button>
