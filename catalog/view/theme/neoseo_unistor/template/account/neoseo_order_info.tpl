                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-right" style="white-space: nowrap;"><?php if ($product['reorder']) { ?>
                                <a onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" data-toggle="tooltip" title="<?php echo $button_reorder; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i></a>
                            <?php } ?>
                        </td>
                    </tr>
                    <?php } ?>
