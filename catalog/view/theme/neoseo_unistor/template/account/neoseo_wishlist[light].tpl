...
<div class="container">
    ...
    <div class="row">
        ...
        <div id="content" class="<?php echo $class; ?>">
            ...
            <?php } else { ?>
            <div class="portable-sorts" style="justify-content: center;">
            ...
            <div class="product-previews-light --category module-grid-<?php echo $limit_p; ?> light">
                    ...
                    <div class="product-preview__thumb box-shadow box-corner">
                        ...
                        <div class="product-preview__thumb-bottom">
                            ...
                            <div class="product-preview__thumb-buttons">
                                ...
                                <?php } ?>
                                <a data-toggle="tooltip" title="<?php echo $text_remove_it; ?>" class="wishlist remove_it" href="<?php echo $product['remove']; ?>">
