...
<div class="container">
    ...
    <div class="row"><?php echo $column_left; ?>
        ...
        <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
            <div class="account-container box-shadow box-corner table-responsive">
                <h1><?php echo $heading_title; ?></h1>
                <?php if ($products) { ?>
                <table class="table table-bordered tabco1">
                    <thead>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo $product['href']; ?>" title="<?php echo $product['name']; ?>"><strong><?php echo $product['name']; ?></strong></a>
                        </td>
                        <?php } ?>
                    </tr>
                    <tr>
                    ...
                    <?php if(isset($attribute_group['attribute'])) { ?>
...
<script>
    var t = $('table.tabco1 tbody:first tr:first td').size();
    if(t == 5) { $('table.tabco1 tbody td').css('width','20%'); }
    if(t == 4) { $('table.tabco1 tbody td').css('width','25%'); }
    if(t == 3) { $('table.tabco1 tbody td').css('width','33%'); }
    if(t == 2) { $('table.tabco1 tbody td').css('width','50%'); }
</script>
<?php echo $footer; ?>