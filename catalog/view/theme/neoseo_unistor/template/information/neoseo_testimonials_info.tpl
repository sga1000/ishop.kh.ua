            ...
            <div class="testimonial-users-container box-shadow box-corner">
                ...
                <div class="item">
                    <div class="testimonial-reviewer">
                        ...
                        <div class="user-image" style="margin-bottom: 10px"><img src="<?php echo $testimonial['user_image']; ?>" /></div>
                        <?php } ?>
                        <div class="line1">
                        ...
                        <div class="youtube variable" style="margin: 20px 0"><?php echo $testimonial['youtube']; ?></div>
                        <?php } ?>
                        <br>
