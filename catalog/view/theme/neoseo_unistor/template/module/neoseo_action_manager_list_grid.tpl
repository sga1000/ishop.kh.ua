<div id="actions">
    ...
    <div class="container">
        <div class="">
            <h1 class="action-grid-heading"><?php echo $actions_heading; ?></h1>
                ...
                <div class="col-xs-12 col-sm-6 col-lg-3">
                    <div class="action-item-grid">
                        <div class="action-item-grid__image">
                            <img alt="<?php echo $action["name"]; ?>" src="<?php echo $action["image"]; ?>" width="<?php echo $image_width; ?>" height="<?php echo $image_height; ?>">
                        </div>
