<div class="module">
   ...
   <div class='ft-rows-wrap'>
      ...
      <div class="row">
         <div class="module-grid-<?php echo $limit_p; ?> default">
                  ...
                  <div class="product-thumb_top">
                     ...
                     <div class="image">
                        <a href="<?php echo $product['href']; ?>" title="<?php echo $product['name']; ?>">
                           ...
                           <img src="<?php echo $product['thumb']; ?>" width="200" height="200" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="hoverable img-responsive" data-over="<?php echo $product['thumb']; ?>" data-out="<?php echo $product['thumb']; ?>" />
                           <?php } else { ?>
                  ...
                  <div class="description">
                     ...
                     <div class="description-bottom">
                        <div class="button-group">
                           ...
                           <?php if(!$product['snwa_status'] && ($neoseo_quick_order_status || $soforp_quickorder_status)) { ?>
