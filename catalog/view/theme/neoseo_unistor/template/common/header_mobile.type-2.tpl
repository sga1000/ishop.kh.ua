...
<div class="header-mobile-2">
    <?php if ( $text_header_information != '' ) { ?>
      <div class="header-mobile-2__information">
          <span><?php echo $text_header_information; ?></span>
      </div>
    <?php } ?>
    <div class="header-mobile-2__box">
        <div class="header-mobile-2__button-menu" onclick="$('.header-mobile-2__menu').addClass('active')">
            <span></span>
            <span></span>
            <span></span>
        </div>
        <div class="header-mobile-2__search">
            <button onclick="$('.header-mobile-2__search-popup').addClass('active')" class="header-mobile-2__search-button"><i class="fa fa-search"></i></button>
        </div>
        <div class="header-mobile-2__logo">
        ...
        <div class="header-mobile-2__user">
            <a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>">
                <i class="fa fa-user"></i>
            </a>
        </div>
        <div class="header-mobile-2__cart">
            <a class="header-mobile__cart-link" href="<?php echo $shopping_cart; ?>">
                <i class="fa fa-shopping-basket" aria-hidden="true"></i><?php if( $unistor_cart_total > 0 ) { ?><span class="--total"><?php echo $unistor_cart_total; ?></span><?php } ?>
            </a>
        </div>
    </div>
	...
	<!--Магазін працює-->
	<div style="text-align: center; color: green; font-size: 25px; font-weight: bold;">
		<span>Магазин працює!</span>
	</div>
    <div id="header-mobile-2-search" class="header-mobile-2__search-popup">
        <?php echo $search; ?>
        <div class="header-mobile-2__search-close" onclick="$(this).parent().removeClass('active')"></div>
    </div>

    <div class="header-mobile-2__menu">
        <div class="header-mobile-2__menu-close" onclick="$('.header-mobile-2__menu').removeClass('active')"></div>
        <div class="header-mobile-2__content">
        <div class="header-mobile-2__menu-logo">
            <?php if ( $logo || $unistor_logo ) { ?>
            <?php if ($is_home) { ?>
            <img src="<?php echo $unistor_logo ? $unistor_logo : $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" class="img-responsive" width="<?php echo $logo_sizes[0]; ?>" height="<?php echo $logo_sizes[1]; ?>"/>
            <?php } else { ?>
        ...
        <ul class="header-mobile-2__menu-list">
            <?php foreach ($categories as $category) {  ?>
            <?php if ($category['children']) { ?>
            <li>
                <a <?php if ($category['href']) { ?>href="<?php echo $category['href']; ?>" <?php } ?> >
                    <?php echo $category['name']; ?>
                </a>
                <span class="children-icon" onclick="$(this).next().slideToggle();"><i class="fa fa-angle-down"></i></span>
                <div class="header-mobile-2__menu-children">
                    <ul class="list-unstyled">
                        ...
                        <li>
                            ...
                            <?php } ?>
                            <?php if ($child['children']) { ?>
                            <div class="header-mobile-2__menu-children-2">
                                <ul class="list-unstyled">
