...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="cart-container box-shadow box-corner">
        <!-- warnings -->
        <?php if ($attention) { ?>
            ...
            <table class="table table-bordered">
              ...
              <tr>
                <td class="text-center"><?php if ($product['thumb']) { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left basket-name">
                ...
                <td class="text-right basket-price"><?php echo $product['price']; ?></td>
                <td class="text-right basket-total"><?php echo $product['total']; ?></td>
                <td class="text-right basket-delete"><span><button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger" onclick="cart.remove('<?php echo $product['cart_id']; ?>');"><i class="fa fa-times"></i></button></span></td>
              </tr>
              <?php } ?>
          ...
          <div class="col-sm-5 col-sm-offset-7">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td class="text-right basket-total-price"><?php echo $total['text']; ?></td>
              </tr>
              <?php } ?>
            </table>
          </div>
        </div>
        <div class="buttons cart-button clearfix">
          <div class="pull-left"><a href="<?php echo $continue; ?>" class="btn btn-default"><i class="fa fa-long-arrow-left" aria-hidden="true"></i><?php echo $button_shopping; ?></a></div>
          <div class="pull-right"><a href="<?php echo $checkout; ?>" class="btn btn-primary"><?php echo $button_checkout; ?></a></div>


				<!-- NeoSeo QuickOrder - begin -->
				<?php if (!empty($neoseo_quick_order_cart_template)) echo $neoseo_quick_order_cart_template; ?>
