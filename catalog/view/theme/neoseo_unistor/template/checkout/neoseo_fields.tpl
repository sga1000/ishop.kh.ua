...
foreach ($fields as $field_array_id => $field) {
...
<div class="row field form-group<?php echo $error_style; ?><?php echo $required; ?>">
	...
	<div class="col-sm-8">
		<input type="text" class="form-control" id="<?php echo $field_id; ?>" data-register="<?php echo $only_register;?>" name="<?php echo $name; ?>" value="<?php echo $value; ?>" class="large-field" /> <?php echo $error_name; ?>
	</div>
	<?php if($field['name'] == 'telephone' && $use_international_phone_mask == 1) { ?>
	<script>
		$(document).ready(function() {
			$("#<?php echo $field_id; ?>").intlTelInput({
				...
				initialCountry: "<?php echo $config_country['iso_code_2']; ?>"
			});
			$("#<?php echo $field_id; ?>").intlTelInput("selectCountry", "<?php echo $config_country['iso_code_2']; ?>");
        });
    </script>
	<?php }elseif($field['mask']){ ?>
	<script>$("#<?php echo $field_id; ?>").mask("<?php echo $field['mask']; ?>");</script>
	<?php } ?>
</div>
...
<div class="row field form-group<?php echo $error_style; ?><?php echo $required; ?>">
	...
	<div class="col-sm-8">
		<input type="password" class="form-control" id="<?php echo $field_id; ?>" data-register="<?php echo $only_register;?>" name="<?php echo $name; ?>" value="<?php echo $value; ?>" class="large-field" /> <?php echo $error_name; ?>
	</div>
</div>
<?php } else if( $type == "checkbox") { ?>
<div class="row field form-group<?php echo $error_style; ?><?php echo $required; ?>">
	<div style="padding-left:35px" class="col-sm-offset-4 col-sm-8 checkbox checkbox-primary checkbox-inline">
		<input type="checkbox" id="<?php echo $field_id; ?>" data-register="<?php echo $only_register;?>" name="<?php echo $name; ?>" <?php if ( $value ) echo 'checked="checked"'; ?> /> <?php echo $error_name; ?>
		       <label for="<?php echo $field_id; ?>" class="control-label"><?php echo $label; ?></label>
	</div>
</div>
...
<div class="row field form-group<?php echo $error_style; ?><?php echo $required; ?>">
	<div class="col-sm-offset-4 col-sm-8 radio radio-primary radio-inline">
		<input type="radio" id="<?php echo $field_id.'_'.$field_array_id; ?>" data-register="<?php echo $only_register;?>" name="<?php echo $name; ?>" value="<?php echo $value; ?>" /> <?php echo $error_name; ?>
		<label for="<?php echo $field_id.'_'.$field_array_id; ?>" class="control-label"><?php echo $label; ?>:</label>
	</div>
</div>
<?php } ?>
